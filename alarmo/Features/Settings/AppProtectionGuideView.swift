            ...
            ZStack {
                ...
                VStack(alignment: .leading, spacing: Spacing.xl) {
                    ...
                    VStack(alignment: .leading, spacing: Spacing.m) {
                        ...
                        Text("Ensure alarms ring when Sleep/Do Not Disturb is active:")
                            .font(.system(size: 15))
                            .foregroundColor(Colors.textSecondary)
                        
                        VStack(alignment: .leading, spacing: Spacing.m) {
                            StepView(number: 1, text: "Open iOS Settings > Focus")
                            StepView(number: 2, text: "Select 'Sleep' (or active mode)")
                            StepView(number: 3, text: "Tap 'Apps' under Allowed Notifications")
                            StepView(number: 4, text: "Add 'Alarmo' to the list")
                        }
